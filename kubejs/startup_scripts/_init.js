...
//Creating the function to extremely easily define the different Voltages that GT offers in Recipe creation
// Useful functions

function Tier(voltage) {
    let t;
    switch(voltage) {
        case 'ulv': t = GTValues.ULV; break;
        case 'lv': t = GTValues.LV; break;
        case 'mv': t = GTValues.MV; break;
        case 'hv': t = GTValues.HV; break;
        case 'ev': t = GTValues.EV; break;
        case 'iv': t = GTValues.IV; break;
        case 'luv': t = GTValues.LuV; break;
        case 'zpm': t = GTValues.ZPM; break;
        case 'uv': t = GTValues.UV; break;
        case 'uhv': t = GTValues.UHV; break;
        case 'uev': t = GTValues.UEV; break;
        case 'uiv': t = GTValues.UIV; break;
        case 'uxv': t = GTValues.UXV; break;
        case 'opv': t = GTValues.OpV; break;
        case 'max': t = GTValues.MAX; break;
    }
}
