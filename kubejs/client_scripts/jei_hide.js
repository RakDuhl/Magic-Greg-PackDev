...
//        event.hide(Item.of('mekanism:creative_fluid_tank', '{mekData:{FluidTanks:[{Tank:0b,stored:{Amount:2147483647,FluidName:}}]}}'))
        ...
        event.hide(/gtceu:(granite|diorite|andesite|tuff|sand|red_sand|gravel|basalt|netherrack|endstone|red_granite|marble|blackstone|kivi|asurine|crimsite|limestone|ochrum|scoria|scorchia|veridium)_.*_ore/)
