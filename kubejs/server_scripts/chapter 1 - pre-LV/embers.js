...
const rawMaterials = [
    ...
    { item: 'gtceu:raw_goethite',               fluid: 'embers:molten_iron',    amount: 272},
    { item: 'gtceu:raw_goethite_block',         fluid: 'embers:molten_iron',    amount: 2304},
    { item: 'gtceu:raw_cobaltite',              fluid: 'gtceu:cobalt',          amount: 272},
    { item: 'gtceu:raw_cobaltite_block',        fluid: 'gtceu:cobalt',          amount: 2304},
    { item: 'gtceu:raw_magnetite',              fluid: 'embers:molten_iron',    amount: 272},
    { item: 'gtceu:raw_magnetite_block',        fluid: 'embers:molten_iron',    amount: 2304},
    ...
    { item: 'gtceu:raw_pyrite',                 fluid: 'embers:molten_iron',    amount: 272},
    { item: 'gtceu:raw_pyrite_block',           fluid: 'embers:molten_iron',    amount: 2304},
    ...
    { item: 'gtceu:raw_yellow_limonite',        fluid: 'embers:molten_iron',    amount: 272},
    { item: 'gtceu:raw_yellow_limonite_block',  fluid: 'embers:molten_iron',    amount: 2304},
...
const rawBonusMaterials = [
    ...
    { item: 'minecraft:raw_iron',                       fluid: 'embers:molten_iron',    amount: 272, bonus: 'embers:molten_nickel', Bamount: 48},
    { item: 'minecraft:raw_iron_block',                 fluid: 'embers:molten_iron',    amount: 2304, bonus: 'embers:molten_nickel', Bamount: 432},
    { item: 'gtceu:raw_hematite',                       fluid: 'embers:molten_iron',    amount: 272, bonus: 'gtceu:magnesium', Bamount: 16},
    { item: 'gtceu:raw_hematite_block',                 fluid: 'embers:molten_iron',    amount: 2304, bonus: 'gtceu:magnesium', Bamount: 144},
    ...
    { item: 'gtceu:raw_garnierite',                     fluid: 'embers:molten_nickel',  amount: 272, bonus: 'embers:molten_iron', Bamount: 32},
    { item: 'gtceu:raw_garnierite_block',               fluid: 'embers:molten_nickel',  amount: 2304, bonus: 'embers:molten_iron', Bamount: 288},
    { item: 'gtceu:raw_nickel',                         fluid: 'embers:molten_nickel',  amount: 272, bonus: 'embers:molten_iron', Bamount: 48},
    { item: 'gtceu:raw_nickel_block',                   fluid: 'embers:molten_nickel',  amount: 2304, bonus: 'embers:molten_iron', Bamount: 432},
